...
def update():
	...
	current_exchange_rate, last_refreshed = alpha_data.get_current_exchange_rate(from_symbol, to_symbol)
	return jsonify({'result': 'success', 'current_exchange_rate': current_exchange_rate, 'last_refreshed': last_refreshed})